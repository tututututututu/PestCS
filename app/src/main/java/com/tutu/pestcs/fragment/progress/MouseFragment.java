...
public class MouseFragment extends BaseFragment {
    ...
    private void initData() {
        ...
        int hadCCheakedUnitIn03 =  ShuDao.getHadCheakedUnitInCount("03")+ShuDao.getHadCheakedUnitInCount("11")+ShuDao.getHadCheakedUnitInCount("12");
        int hadCCheakedRoomIn03 =  ShuDao.getHadCheakedRoomInCount("03")+ShuDao.getHadCheakedRoomInCount("11")+ShuDao.getHadCheakedRoomInCount("12");
