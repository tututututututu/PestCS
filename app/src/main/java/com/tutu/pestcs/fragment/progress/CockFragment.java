...
public class CockFragment extends BaseFragment {
	...
	private void initData() {
		...
		int hadCCheakedUnitIn03 =  ZhangDao.getHadCheakedUnitInCount("03")+ZhangDao.getHadCheakedUnitInCount("09")+ZhangDao.getHadCheakedUnitInCount("11")+ZhangDao.getHadCheakedUnitInCount("12");
		int hadCCheakedRoomIn03 =  ZhangDao.getHadCheakedRoomInCount("03")+ZhangDao.getHadCheakedRoomInCount("09")+ZhangDao.getHadCheakedUnitInCount("11")+ZhangDao.getHadCheakedRoomInCount("12");
